...
// Sample initial data
let allFeedItems = [
    new FeedItem('ramen', 'dumpling', 'noodle', 'sushi'),   // Only 4 args per constructor
    new FeedItem('fries', 'chicken', 'burger', 'pizza'),
    new FeedItem('chips', 'pretzels', 'crackers', 'goldfish')
];
